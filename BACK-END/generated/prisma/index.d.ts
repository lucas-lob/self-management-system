...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    meta: {
      modelProps: "user" | "category" | "activity" | "pomodoroSettings"
    ...
    model: {
      ...
      PomodoroSettings: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.PomodoroSettingsFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.PomodoroSettingsAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type PomodoroSettingsAvgAggregateOutputType = {
    ...
    shortIntervalDuration: number | null
    longIntervalDuration: number | null
  ...
  export type PomodoroSettingsSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetSelect<{
    ...
    shortIntervalDuration?: boolean
    longIntervalDuration?: boolean
    sectionQuantity?: boolean
  ...
  export type PomodoroSettingsOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "userId" | "sectionDuration" | "shortIntervalDuration" | "longIntervalDuration" | "sectionQuantity" | "notificationSound", ExtArgs["result"]["pomodoroSettings"]>
  ...
  export interface PomodoroSettingsDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more PomodoroSettings that matches the filter.
     * @param {PomodoroSettingsFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const pomodoroSettings = await prisma.pomodoroSettings.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: PomodoroSettingsFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a PomodoroSettings.
     * @param {PomodoroSettingsAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const pomodoroSettings = await prisma.pomodoroSettings.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
     * })
     */
    aggregateRaw(args?: PomodoroSettingsAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface PomodoroSettingsFieldRefs {
    ...
    readonly sectionDuration: FieldRef<"PomodoroSettings", 'Int[]'>
    readonly shortIntervalDuration: FieldRef<"PomodoroSettings", 'Int[]'>
    readonly longIntervalDuration: FieldRef<"PomodoroSettings", 'Int[]'>
    readonly sectionQuantity: FieldRef<"PomodoroSettings", 'Int'>
    readonly notificationSound: FieldRef<"PomodoroSettings", 'String'>
  }
  ...
  /**
   * PomodoroSettings findRaw
   */
  export type PomodoroSettingsFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
  ...
  /**
   * PomodoroSettings aggregateRaw
   */
  export type PomodoroSettingsAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type PomodoroSettingsWhereInput = {
    ...
    sectionDuration?: IntNullableListFilter<"PomodoroSettings">
    shortIntervalDuration?: IntNullableListFilter<"PomodoroSettings">
    longIntervalDuration?: IntNullableListFilter<"PomodoroSettings">
    sectionQuantity?: IntFilter<"PomodoroSettings"> | number
    notificationSound?: StringFilter<"PomodoroSettings"> | string
    user?: XOR<UserScalarRelationFilter, UserWhereInput>
  }
  ...
  export type PomodoroSettingsOrderByWithRelationInput = {
    id?: SortOrder
    userId?: SortOrder
    sectionDuration?: SortOrder
    shortIntervalDuration?: SortOrder
    longIntervalDuration?: SortOrder
    sectionQuantity?: SortOrder
  ...
  export type PomodoroSettingsScalarWhereWithAggregatesInput = {
    ...
    shortIntervalDuration?: IntNullableListFilter<"PomodoroSettings">
    longIntervalDuration?: IntNullableListFilter<"PomodoroSettings">
    sectionQuantity?: IntWithAggregatesFilter<"PomodoroSettings"> | number
    notificationSound?: StringWithAggregatesFilter<"PomodoroSettings"> | string
  }
  ...
  export type PomodoroSettingsCreateInput = {
    id?: string
    sectionDuration?: PomodoroSettingsCreatesectionDurationInput | number[]
    shortIntervalDuration?: PomodoroSettingsCreateshortIntervalDurationInput | number[]
    longIntervalDuration?: PomodoroSettingsCreatelongIntervalDurationInput | number[]
    sectionQuantity?: number
    notificationSound?: string
  ...
  export type PomodoroSettingsUpdateInput = {
    sectionDuration?: PomodoroSettingsUpdatesectionDurationInput | number[]
    shortIntervalDuration?: PomodoroSettingsUpdateshortIntervalDurationInput | number[]
    longIntervalDuration?: PomodoroSettingsUpdatelongIntervalDurationInput | number[]
    sectionQuantity?: IntFieldUpdateOperationsInput | number
    notificationSound?: StringFieldUpdateOperationsInput | string
  ...
  export type PomodoroSettingsCreatesectionDurationInput = {
    set: number[]
  }

  export type PomodoroSettingsCreateshortIntervalDurationInput = {
    set: number[]
  }

  export type PomodoroSettingsCreatelongIntervalDurationInput = {
    set: number[]
  }
  ...
  export type PomodoroSettingsUpdatesectionDurationInput = {
    set?: number[]
    push?: number | number[]
  }

  export type PomodoroSettingsUpdateshortIntervalDurationInput = {
    set?: number[]
    push?: number | number[]
  }

  export type PomodoroSettingsUpdatelongIntervalDurationInput = {
    set?: number[]
    push?: number | number[]
  }
